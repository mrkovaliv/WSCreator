export const DEFAULT_CONTENT = {
  ...
  about: {
    ...
    title: "Фотостудія Lion Production",
    description:
      "Найбільша фотостудія та креативний простір для подій поруч із студмістечком КПІ. Ми зібрали досвідчених фахівців та надійне обладнання, щоб створити найкращі умови для фотографів та втілення будь-яких ідей. Чотири масштабні циклорами, павільйони з інтер'єрами та студії для предметної зйомки. Великий зал для конференцій, лекцій та тренінгів, що легко трансформується.",
  },
  service: {
    color: "#fff",
    backgroundColor: "#1b1f20",
